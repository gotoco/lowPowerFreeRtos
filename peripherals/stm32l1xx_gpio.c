...
/**
  ...
  * @param  GPIOx: where x can be (A..H) to select the GPIO peripheral.
  * @param  GPIO_InitStruct: pointer to a GPIOInitTypeDef structure that
  *         contains the configuration information for the specified GPIO
  *         peripheral.

  * @retval None
  */
void GPIO_Init(GPIO_TypeDef* GPIOx, GPIOInitTypeDef* GPIO_InitStruct)
{
...
/**
  ...
  * @param  GPIO_InitStruct : pointer to a GPIOInitTypeDef structure which will
  *         be initialized.
  * @retval None
  */
void GPIO_StructInit(GPIOInitTypeDef* GPIO_InitStruct)
{
