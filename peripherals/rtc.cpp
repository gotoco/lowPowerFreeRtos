...
/* Global variables*/
 volatile uint32_t __EXT_AsynchPrediv = 0;
 volatile uint32_t __EXT_SynchPrediv = 0;
...
ErrorStatus RTC_Init(RTC_InitTypeDef* RTC_InitStruct) {
	...
	periph_assert(__IS_RTC_HOUR_FORMAT(RTC_InitStruct->RTC_HourFormat));
	periph_assert(__IS_RTC_ASYNCH_PREDIV(RTC_InitStruct->RTC_AsynchPrediv));
	periph_assert(__IS_RTC_SYNCH_PREDIV(RTC_InitStruct->RTC_SynchPrediv));
...
void RTC_WriteProtectionCmd(FunctionalState NewState) {
	/* Check the parameters */
	periph_assert(__IS_FUNCTIONAL_STATE(NewState));
...
ErrorStatus RTC_SetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct) {
	...
	/* Check the parameters */
	periph_assert(__IS_RTC_FORMAT(RTC_Format));

	if (RTC_Format == RTC_Format_BIN) {
		if ((RTC->CR & RTC_CR_FMT) != (uint32_t) RESET) {
			periph_assert(__IS_RTC_HOUR12(RTC_TimeStruct->RTC_Hours));
			periph_assert(__IS_RTC_H12(RTC_TimeStruct->RTC_H12));
		} else {
			RTC_TimeStruct->RTC_H12 = 0x00;
			periph_assert(__IS_RTC_HOUR24(RTC_TimeStruct->RTC_Hours));
		}
		periph_assert(__IS_RTC_MINUTES(RTC_TimeStruct->RTC_Minutes));
		periph_assert(__IS_RTC_SECONDS(RTC_TimeStruct->RTC_Seconds));
	} else {
		if ((RTC->CR & RTC_CR_FMT) != (uint32_t) RESET) {
			tmpreg = RTC_Bcd2ToByte(RTC_TimeStruct->RTC_Hours);
			periph_assert(__IS_RTC_HOUR12(tmpreg));
			periph_assert(__IS_RTC_H12(RTC_TimeStruct->RTC_H12));
		} else {
			RTC_TimeStruct->RTC_H12 = 0x00;
			periph_assert(
					__IS_RTC_HOUR24(RTC_Bcd2ToByte(RTC_TimeStruct->RTC_Hours)));
		}
		periph_assert(
				__IS_RTC_MINUTES(RTC_Bcd2ToByte(RTC_TimeStruct->RTC_Minutes)));
		periph_assert(
				__IS_RTC_SECONDS(RTC_Bcd2ToByte(RTC_TimeStruct->RTC_Seconds)));
	}
...
ErrorStatus RTC_SetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct) {
	...
	if (RTC_Format == RTC_Format_BIN) {
		periph_assert(__IS_RTC_YEAR(RTC_DateStruct->RTC_Year));
		periph_assert(__IS_RTC_MONTH(RTC_DateStruct->RTC_Month));
		periph_assert(__IS_RTC_DATE(RTC_DateStruct->RTC_Date));
	} else {
		periph_assert(__IS_RTC_YEAR(RTC_Bcd2ToByte(RTC_DateStruct->RTC_Year)));
		tmpreg = RTC_Bcd2ToByte(RTC_DateStruct->RTC_Month);
		periph_assert(__IS_RTC_MONTH(tmpreg));
		tmpreg = RTC_Bcd2ToByte(RTC_DateStruct->RTC_Date);
		periph_assert(__IS_RTC_DATE(tmpreg));
	}
	periph_assert(__IS_RTC_WEEKDAY(RTC_DateStruct->RTC_WeekDay));
...
void RTC_SetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm,
	...
	/* Check the parameters */
	periph_assert(__IS_RTC_FORMAT(RTC_Format));
	periph_assert(__IS_RTC_ALARM(RTC_Alarm));
	periph_assert(__IS_ALARM_MASK(RTC_AlarmStruct->RTC_AlarmMask));
	periph_assert(__IS_RTC_ALARM_DATE_WEEKDAY_SEL(RTC_AlarmStruct->RTC_AlarmDateWeekDaySel));

	if (RTC_Format == RTC_Format_BIN) {
		if ((RTC->CR & RTC_CR_FMT) != (uint32_t) RESET) {
			periph_assert(__IS_RTC_HOUR12(RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours));
			periph_assert(__IS_RTC_H12(RTC_AlarmStruct->RTC_AlarmTime.RTC_H12));
		} else {
			RTC_AlarmStruct->RTC_AlarmTime.RTC_H12 = 0x00;
			periph_assert(__IS_RTC_HOUR24(RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours));
		}
		periph_assert(__IS_RTC_MINUTES(RTC_AlarmStruct->RTC_AlarmTime.RTC_Minutes));
		periph_assert(__IS_RTC_SECONDS(RTC_AlarmStruct->RTC_AlarmTime.RTC_Seconds));

		if (RTC_AlarmStruct->RTC_AlarmDateWeekDaySel == RTC_AlarmDateWeekDaySel_Date) {
			periph_assert(__IS_RTC_ALARM_DATE_WEEKDAY_DATE(RTC_AlarmStruct->RTC_AlarmDateWeekDay));
		} else {
			periph_assert(__IS_RTC_ALARM_DATE_WEEKDAY_WEEKDAY(RTC_AlarmStruct->RTC_AlarmDateWeekDay));
		}
	} else {
		if ((RTC->CR & RTC_CR_FMT) != (uint32_t) RESET) {
			...
			RTC_AlarmStruct->RTC_AlarmTime.RTC_H12 = 0x00;
			periph_assert(
					__IS_RTC_HOUR24(RTC_Bcd2ToByte(RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours)));
		}

		periph_assert(__IS_RTC_MINUTES(RTC_Bcd2ToByte(RTC_AlarmStruct->RTC_AlarmTime.RTC_Minutes)));
		periph_assert(__IS_RTC_SECONDS(RTC_Bcd2ToByte(RTC_AlarmStruct->RTC_AlarmTime.RTC_Seconds)));

		if (RTC_AlarmStruct->RTC_AlarmDateWeekDaySel == RTC_AlarmDateWeekDaySel_Date) {
			tmpreg = RTC_Bcd2ToByte(RTC_AlarmStruct->RTC_AlarmDateWeekDay);
			periph_assert(__IS_RTC_ALARM_DATE_WEEKDAY_DATE(tmpreg));
		} else {
			tmpreg = RTC_Bcd2ToByte(RTC_AlarmStruct->RTC_AlarmDateWeekDay);
			periph_assert(__IS_RTC_ALARM_DATE_WEEKDAY_WEEKDAY(tmpreg));
		}
	}
...
ErrorStatus RTC_AlarmCmd(uint32_t RTC_Alarm, FunctionalState NewState) {
	...
	/* Check the parameters */
	periph_assert(__IS_RTC_CMD_ALARM(RTC_Alarm));
	periph_assert(__IS_FUNCTIONAL_STATE(NewState));
...
void RTC_AlarmSubSecondConfig(uint32_t RTC_Alarm,
		uint32_t RTC_AlarmSubSecondValue, uint32_t RTC_AlarmSubSecondMask) {
	uint32_t tmpreg = 0;

	/* Check the parameters */
	periph_assert(__IS_RTC_ALARM(RTC_Alarm));
	periph_assert(__IS_RTC_ALARM_SUB_SECOND_VALUE(RTC_AlarmSubSecondValue));
	periph_assert(__IS_RTC_ALARM_SUB_SECOND_MASK(RTC_AlarmSubSecondMask));
...
void RTC_WakeUpClockConfig(uint32_t RTC_WakeUpClock) {
	/* Check the parameters */
	periph_assert(__IS_RTC_WAKEUP_CLOCK(RTC_WakeUpClock));
...
void RTC_SetWakeUpCounter(uint32_t RTC_WakeUpCounter) {
	/* Check the parameters */
	periph_assert(__IS_RTC_WAKEUP_COUNTER(RTC_WakeUpCounter));
...
void RTC_DayLightSavingConfig(uint32_t RTC_DayLightSaving,
	...
	/* Check the parameters */
	periph_assert(__IS_RTC_DAYLIGHT_SAVING(RTC_DayLightSaving));
	periph_assert(__IS_RTC_STORE_OPERATION(RTC_StoreOperation));
...
void RTC_OutputConfig(uint32_t RTC_Output, uint32_t RTC_OutputPolarity) {
	/* Check the parameters */
	periph_assert(__IS_RTC_OUTPUT(RTC_Output));
	periph_assert(__IS_RTC_OUTPUT_POL(RTC_OutputPolarity));
...
ErrorStatus RTC_CoarseCalibConfig(uint32_t RTC_CalibSign, uint32_t Value) {
	...
	/* Check the parameters */
	periph_assert(__IS_RTC_CALIB_SIGN(RTC_CalibSign));
	periph_assert(__IS_RTC_CALIB_VALUE(Value));
...
void RTC_CalibOutputConfig(uint32_t RTC_CalibOutput) {
	/* Check the parameters */
	periph_assert(__IS_RTC_CALIB_OUTPUT(RTC_CalibOutput) );
...
ErrorStatus RTC_SmoothCalibConfig(uint32_t RTC_SmoothCalibPeriod,
	...
	/* Check the parameters */
	periph_assert(__IS_RTC_SMOOTH_CALIB_PERIOD(RTC_SmoothCalibPeriod));
	periph_assert(__IS_RTC_SMOOTH_CALIB_PLUS(RTC_SmoothCalibPlusPulses));
	periph_assert(__IS_RTC_SMOOTH_CALIB_MINUS(RTC_SmouthCalibMinusPulsesValue));
...
void RTC_TimeStampCmd(uint32_t RTC_TimeStampEdge, FunctionalState NewState) {
	...
	/* Check the parameters */
	periph_assert(__IS_RTC_TIMESTAMP_EDGE(RTC_TimeStampEdge));
	periph_assert(__IS_FUNCTIONAL_STATE(NewState));
...
void RTC_TamperTriggerConfig(uint32_t RTC_Tamper, uint32_t RTC_TamperTrigger) {
	/* Check the parameters */
	periph_assert(__IS_RTC_TAMPER(RTC_Tamper));
	periph_assert(__IS_RTC_TAMPER_TRIGGER(RTC_TamperTrigger));
...
void RTC_TamperFilterConfig(uint32_t RTC_TamperFilter) {
	/* Check the parameters */
	periph_assert(__IS_RTC_TAMPER_FILTER(RTC_TamperFilter));
...
void RTC_TamperSamplingFreqConfig(uint32_t RTC_TamperSamplingFreq) {
	/* Check the parameters */
	periph_assert(__IS_RTC_TAMPER_SAMPLING_FREQ(RTC_TamperSamplingFreq));
...
void RTC_TamperPinsPrechargeDuration(uint32_t RTC_TamperPrechargeDuration) {
	/* Check the parameters */
	periph_assert(
			__IS_RTC_TAMPER_PRECHARGE_DURATION(RTC_TamperPrechargeDuration));
...
void RTC_WriteBackupRegister(uint32_t RTC_BKP_DR, uint32_t Data) {
	...
	/* Check the parameters */
	periph_assert(__IS_RTC_BKP(RTC_BKP_DR));
...
void RTC_OutputTypeConfig(uint32_t RTC_OutputType) {
	/* Check the parameters */
	periph_assert(__IS_RTC_OUTPUT_TYPE(RTC_OutputType));
...
ErrorStatus RTC_SynchroShiftConfig(uint32_t RTC_ShiftAdd1S,
	...
	/* Check the parameters */
	periph_assert(__IS_RTC_SHIFT_ADD1S(RTC_ShiftAdd1S));
	periph_assert(__IS_RTC_SHIFT_SUBFS(RTC_ShiftSubFS));
...
void RTC_ITConfig(uint32_t RTC_IT, FunctionalState NewState) {
	/* Check the parameters */
	periph_assert(__IS_RTC_CONFIG_IT(RTC_IT));
	periph_assert(__IS_FUNCTIONAL_STATE(NewState));
...
FlagStatus RTC_GetFlagStatus(uint32_t RTC_FLAG) {
	...
	/* Check the parameters */
	periph_assert(__IS_RTC_GET_FLAG(RTC_FLAG));
...
void RTC_ClearFlag(uint32_t RTC_FLAG) {
	/* Check the parameters */
	periph_assert(__IS_RTC_CLEAR_FLAG(RTC_FLAG));
...
ITStatus RTC_GetITStatus(uint32_t RTC_IT) {
	...
	/* Check the parameters */
	periph_assert(__IS_RTC_GET_IT(RTC_IT));

	/* Get the TAMPER Interrupt enable bit and pending bit */
	tmpreg = (uint32_t)(RTC->TAFCR & (RTC_TAFCR_TAMPIE));

	/* Get the Interrupt enable Status */
	enablestatus = (uint32_t)(
...
void RTC_ClearITPendingBit(uint32_t RTC_IT) {
	...
	/* Check the parameters */
	periph_assert(__IS_RTC_CLEAR_IT(RTC_IT));
...
/**
 * \brief Default end-to-end configuration for RTC
 */
void rtcFastStart(void)
{
	...
	DISABLE_BackupDomainWriteProtection();
	Disable_WriteProtectionTo_RTC_REG();

	RTC_WriteBackupRegister(RTC_BKP_DR0, 0x1111);

	  if (RTC_ReadBackupRegister(RTC_BKP_DR0) != RTC_BACKUP_DOMAIN_PASSWORD)
	  {
	    /* RTC configuration  */
		/* Configure the RTC data register and RTC prescaler */
	    RTC_Config();
	    RTC_InitStructure.RTC_AsynchPrediv = __EXT_AsynchPrediv;
	    RTC_InitStructure.RTC_SynchPrediv  = __EXT_SynchPrediv;
	    RTC_InitStructure.RTC_HourFormat   = RTC_HourFormat_24;

	    /* Check on RTC init */
	    if (RTC_Init(&RTC_InitStructure) == ERROR){/* RTC Prescaler Config failed */}

	    /* Configure the time register */
	    if(RTC_DEFAULT_TIME_CONFIGUTATION)
	    	RTC_DefaultTimeConfigure(&RTC_TimeStruct, &RTC_DateStructure);
	  ...
	  if(RTC_DEFAULT_ALARM_CONFIGUTATION)
	    	RTC_DefaultAlarmConfigure(&RTC_AlarmStructure);
...
void RTC_Config(void) {
	...
	__EXT_SynchPrediv = 0xFF;
	__EXT_AsynchPrediv = 0x7F;
...
#else
#error Please select the RTC Clock source inside the config.h file
...
/**
 * \brief  Setup easily default Time
 */
void RTC_DefaultTimeConfigure(RTC_TimeTypeDef * RTC_TimeStructure, RTC_DateTypeDef * RTC_DateStructure)
{
	  RTC_TimeStructure->RTC_H12     = RTC_DEFAULT_TIME_AM_PM_BASE;
	  RTC_TimeStructure->RTC_Hours 	 = RTC_DEFAULT_TIME_HOURS;
	  RTC_TimeStructure->RTC_Minutes = RTC_DEFAULT_TIME_MINUTES;
	  RTC_TimeStructure->RTC_Seconds = RTC_DEFAULT_TIME_SECOND;

	  RTC_DateStructure->RTC_Date	=	RTC_DEFAULT_DATE_DAY;
	  RTC_DateStructure->RTC_Month	=	RTC_DEFAULT_DATE_MONTH;
	  RTC_DateStructure->RTC_Year	=	RTC_DEFAULT_DATE_YEARS;
	  RTC_DateStructure->RTC_WeekDay	=	RTC_DEFAULT_DATE_WEEKDAY;

	  /* Configure the RTC date-time register */
...
/**
 * \brief  Setup easily default Alarm
 */
void RTC_DefaultAlarmConfigure(RTC_AlarmTypeDef * RTC_AlarmStructure )
 {
	/* Disable the Alarm A */
	RTC_AlarmCmd(RTC_Alarm_A, DISABLE);

	RTC_AlarmStructure->RTC_AlarmTime.RTC_H12 	  = RTC_H12_AM;
	RTC_AlarmStructure->RTC_AlarmTime.RTC_Hours   = RTC_ALARM_DEFAULT_TIME_HOURS;
	RTC_AlarmStructure->RTC_AlarmTime.RTC_Minutes = RTC_ALARM_DEFAULT_TIME_MINUTES;
	RTC_AlarmStructure->RTC_AlarmTime.RTC_Seconds = RTC_ALARM_DEFAULT_TIME_SECOND;

	/* Set the Alarm A */
	RTC_AlarmStructure->RTC_AlarmDateWeekDay 	= RTC_ALARM_DEFAULT_DATE_WEEK;
